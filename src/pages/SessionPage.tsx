...
const MOVEMENT_TYPE_SLOTS: Record<string, number> = {
  flat_press:          7,
  incline_press:       9,
  dip:                11,
  chest_fly:           1,
...
// Build a tone map for a single muscle group, guaranteeing that no two
// movement types within the group share the same palette slot.
function buildGroupToneMap(
